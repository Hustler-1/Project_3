...
test = basicstats::chunkR(cam_names, selection = c("Common.Name", "Count", "Subproject"), group = Common.Name, sum.name = "total")#Here we can use the cam_names data set we generated earlier to create a sub-chunk of the data set that gives use the counts of every animal spotted by the cams.
