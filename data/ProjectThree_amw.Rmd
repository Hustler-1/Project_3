...
## AMW: Installs cleanly from github. Things appear to generally work. It looks like you've caught all your dependencies. 
...
## Amw: You're going to want to clean up your headers a bit - generally don't leave blank lines in your headers. Sometimes its no issue, but will occaisionally cause devtools::document() to have an absolute fit. Also, make sure your description of the package in the DESCRIPTION file gets compeleted. Otherwise, looks nice!
